object fekas: Tfekas
  ...
  object cxGrid1: TcxGrid
    ...
    object GD: TcxGridDBTableView
      ...
      object GDrek: TcxGridDBColumn
        Caption = 'Akun Perkiraan'
        DataBinding.FieldName = 'rek'
        RepositoryItem = FMain.ExPerk
        HeaderAlignmentHorz = taCenter
        Width = 162
      end
      object GDketerangan: TcxGridDBColumn
        Caption = 'Keterangan'
  ...
  object td: TUniQuery
    ...
    SQL.Strings = (
      'select * from trdkas where id = :id order by nomor')
    CachedUpdates = True
  ...
  object rep1: TfrxReport
    ...
    ReportOptions.LastChange = 44004.926698055490000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
      'end.')
    OnPreview = rep1Preview
    Left = 360
    Top = 8
    Datasets = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object ColumnFooter1: TfrxColumnFooter
        ...
        Width = 264.567100000000000000
        object MNTOTAL: TfrxSysMemoView
          Align = baWidth
          AllowVectorExport = True
